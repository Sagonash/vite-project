...
import Post_write_create from '@/components/Post_write_create'
        ...
        <div className='w-full h-full bg-slate-50'>
            ...
            <section className='w-3/4 m-auto flex flex-row justify-center space-x-8'>
                ...
                <div className='space-y-6'>
                    <MenuBar/>
                    <Button className='w-[768px] h-10  bg-baseColor font-customFont text-sm leading-6 font-medium rounded-[6px]'
                        onClick={WinOpen}>
                        Создать пост
                    </Button>
                    <Post_write_create/>
            ...
            <div ref={popupRef} className='bg-[#00000052] opacity-100 fixed min-w-full min-h-full z-10 top-0 left-0 hidden'>
                <div ref={bgRef} className='relative text-baseColor w-[544px] h-[370px] bg-white m-auto rounded-xl'>
                    ...
                    <div className='ml-4 mt-4'>
                        <Button className="bg-baseColor rounded-[6px] font-customFont mr-2" onClick={WinClose}>Опубликовать пост</Button>
                        <Button className="bg-slate-100 rounded-[6px] font-customFont text-baseColor hover:bg-slate-200" onClick={WinClose}>Отправить в черновики</Button>
                    </div>
                </div>
            </div>
        </div>
