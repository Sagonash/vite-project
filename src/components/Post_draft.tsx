...
const Post_draft = () => {
    ...
    return(
        <div className='w-[768px] h-[780px] hover:bg-slate-200 rounded space-x-4 space-y-4'>
            ...
            <div>
                <Button className="bg-baseColor rounded font-customFont mr-2">Опубликовать пост</Button>
                <Button className="bg-slate-100 rounded font-customFont text-baseColor hover:bg-slate-200" onClick={redact}>Редактировать</Button>
            </div>
            <div>
